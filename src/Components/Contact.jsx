...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "049f788a-35ff-4b8a-a0af-26b3a0f14048");
  ...
  return (
    <div className='text-center px-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <button 
             className=' bg-blue-600 text-white py-2 px-12 mb-10 rounded'>{result ? result : "Send Message"}</button>
        </form>
    </div>
  )
}
